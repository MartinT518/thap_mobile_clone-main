...
abstract class $TagModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, @JsonKey(name: 'items') int itemCount});
}
...
class _$TagModelImpl implements _TagModel {
  const _$TagModelImpl({
    required this.id,
    required this.title,
    @JsonKey(name: 'items') required this.itemCount,
  });
  ...
  @override
  String toString() {
    return 'TagModel(id: $id, title: $title, itemCount: $itemCount)';
  }
...
abstract class _TagModel implements TagModel {
  const factory _TagModel({
    ...
    @JsonKey(name: 'items') required final int itemCount,
  }) = _$TagModelImpl;
