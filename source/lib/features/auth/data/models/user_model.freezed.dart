...
class _$UserModelImpl extends _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, email: $email, name: $name, photoUrl: $photoUrl, token: $token, authMethod: $authMethod)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, name, photoUrl, token, authMethod);
